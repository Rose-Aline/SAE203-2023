...
<template>
    ...
    <main class="bg-backgroundbeige">
        ...
        <div class="lg:flex lg:flex-row-reverse lg:mx-12 lg:mr-56 lg:gap-20 lg:bg-beige ">
            <div class="text-center	lg:text-left py-2 pt-10 lg:w-1/2">
                <h1 class="uppercase">Le pictorialisme</h1>
                <h2>Exposition du 13 Avril au 21 Juin 2021</h2>
             </div>
              <img src="../img/Robert_Demarchy_Severity_light.webp" alt="Image" class="lg:w-1/2 lg:h-44 w-full h-80 drop-shadow-[0_10px_10px_rgba(0,0,0,0.30)]	object-cover ">
            </div>
            <div class="pt-10 px-10">
                <div class="lg:flex">
                    <div class="lg:w-1/2 lg:pr-20">
                        <h1 class="uppercase pt-10 hidden lg:block">Le pictorialisme</h1>
                        <hr class="w-72 pb-3 hidden lg:block">
                        <h2 class="font-bold lg:pt-5">Fondation Cartier, 261 Bd Raspail, 75014 Paris</h2>
